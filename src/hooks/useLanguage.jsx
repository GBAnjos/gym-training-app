...
const translations = {
  'pt-BR': {
    ...
    diet_builder_empty: 'Adicione alimentos a esta refeição',
    ...
    import_upload_hint: 'Aceita .txt, .md, .csv, .pdf (máx 10MB)',
  ...
  'en': {
    ...
    diet_builder_empty: 'Add foods to this meal',
    ...
    import_upload_hint: 'Accepts .txt, .md, .csv, .pdf (max 10MB)',
